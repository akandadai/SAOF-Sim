...
if __name__ == '__main__':
	...
	problem_parameters = {"robot_num": 3, "max_subtasks": 3, "max_tasks": 7, "initial_percentage": 0.2, "horizon": 100, "max_distance": 300, "locations": 15}

	simulation_parameters = {"random_seed": 0, "rate": 1.5, "allocation_method": "naive",  "min_available_robots": 1, "max_wait": 0}
